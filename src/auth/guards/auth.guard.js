...
var AuthGuard = function () {
    ...
    var AuthGuard = _classThis = /** @class */ (function () {
        function AuthGuard_1(jwtService, reflector, configService) {
        ...
        AuthGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var isPublic, request, token, payload, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            isPublic = this.reflector.getAllAndOverride(isPublic_decorator_1.IS_PUBLIC_KEY, [
                                context.getHandler(),
                                context.getClass(),
                            ]);
                            if (isPublic) {
