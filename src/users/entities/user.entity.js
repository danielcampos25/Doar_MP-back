...
var UserEntity = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _nome_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'O nome não pode estar vazio.' }), (0, class_validator_1.IsString)({ message: 'O nome deve ser uma string.' })];
            ...
            __esDecorate(null, null, _nome_decorators, { kind: "field", name: "nome", static: false, private: false, access: { has: function (obj) { return "nome" in obj; }, get: function (obj) { return obj.nome; }, set: function (obj, value) { obj.nome = value; } }, metadata: _metadata }, _nome_initializers, _instanceExtraInitializers);
